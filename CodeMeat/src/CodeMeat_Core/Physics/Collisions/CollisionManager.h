...
private:
	...
	static bool PlayerToBoundingBox(Camera* camera, GameObject* object, CollisionData** Data);		//Specific tests depending on types of colliders involved
	...
	static bool SAT_Test_3Point(const glm::vec3& Axis, BoundingBox* box , const glm::vec3& Vec1, const glm::vec3& Vec2, const glm::vec3& Vec3);		//SAT dependant tests
